...
function Userslist() {
    ...
    const fetchUsers = async () => {
      try {
        const response = await axios.get(
          "http://localhost/flightbackend/controllers/api/User/Get/bbook.php"
        );
  ...
  const handleSaveClick = async () => {
    try {
      await axios.put(
        `http://localhost/flightbackend/controllers/api/admin/Put/businessupdate.php`,
        editFormData
      );
      setUsers((prevUsers) =>
        prevUsers.map((user) =>
  ...
  const handleDelete = async (id) => {
    try {
      const response = await axios.post(
        `http://localhost/flightbackend/controllers/api/admin/delete/businessdel.php`,
        { id }
      );
